...
import (
	...
	"github.com/chicopalermo/golang-web-socket/internal/store/pgstore"
...
func (h apiHandler) handleSubscribeToRoom(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		slog.Warn("failed to upgrade connection", "err", err)
...
func (h apiHandler) handleCreateRoom(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		slog.Error("failed to insert room", "err", err)
		http.Error(w, "something went wrong", http.StatusInternalServerError)
		return
	}
...
func (h apiHandler) handleGetRooms(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		slog.Error("failed to get rooms", "err", err)
		http.Error(w, "something went wrong", http.StatusInternalServerError)
		return
	}
...
func (h apiHandler) handleCreateRoomMessage(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		slog.Error("failed to insert message", "err", err)
		http.Error(w, "something went wrong", http.StatusInternalServerError)
		return
	}
...
func (h apiHandler) handleGetRoomMessages(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		slog.Error("failed to get room messages", "err", err)
		http.Error(w, "something went wrong", http.StatusInternalServerError)
		return
	}
...
func (h apiHandler) handleReactToMessage(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		http.Error(w, "something went wrong", http.StatusInternalServerError)
		slog.Error("failed to react to message", "err", err)
		return
	}
...
func (h apiHandler) handleRemoveReactToMessage(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		http.Error(w, "something went wrong", http.StatusInternalServerError)
		slog.Error("failed to remove reaction from message", "err", err)
		return
	}
